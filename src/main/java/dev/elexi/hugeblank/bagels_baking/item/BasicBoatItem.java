...
public class BasicBoatItem extends Item {
    private static final Predicate<Entity> RIDERS = EntityPredicates.EXCEPT_SPECTATOR.and(Entity::collides);
    private final Supplier<EntityType<BasicBoatEntity>> boatEntity;


    public BasicBoatItem(Supplier<EntityType<BasicBoatEntity>> boatEntity, Item.Settings settings) {
        super(settings);
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        BasicBoatEntity boat = createBoat(world, hit.getPos().x, hit.getPos().y, hit.getPos().z);
    ...
    private BasicBoatEntity createBoat(World world, double x, double y, double z) {
        BasicBoatEntity entity = boatEntity.get().create(world);
        if (entity != null) {
            entity.setPos(x, y, z);
