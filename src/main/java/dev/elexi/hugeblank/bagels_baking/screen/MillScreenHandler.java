...
public class MillScreenHandler extends ScreenHandler implements NamedScreenHandlerFactory {
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(MillingRecipe.TYPE, input, this.world);
        }
    ...
    public ItemStack transferSlot(PlayerEntity player, int index) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            } else if (this.world.getRecipeManager().getFirstMatch(MillingRecipe.TYPE, new SimpleInventory(itemStack2), this.world).isPresent()) {
