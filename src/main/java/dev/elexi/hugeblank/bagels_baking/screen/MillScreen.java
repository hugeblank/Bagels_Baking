...
public class MillScreen extends HandledScreen<MillScreenHandler> { // Functionally identical to StonecutterScreen, made for Mill
    ...
    protected void drawMouseoverTooltip(MatrixStack matrices, int x, int y) {
        ...
        if (this.canCraft) {
            ...
            List<MillingRecipe> list = this.handler.getAvailableRecipes();
