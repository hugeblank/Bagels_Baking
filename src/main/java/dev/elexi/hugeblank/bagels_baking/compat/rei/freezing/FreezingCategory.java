...
public class FreezingCategory implements DisplayCategory<FreezingDisplay> {
    ...
    public @NotNull Renderer getIcon() {
        return EntryStacks.of(Baking.ICE_BOX_ITEM);
    }

    @Override
    public Text getTitle() {
        return new TranslatableText("category.rei.freezing");
    }

    @Override
    public @NotNull List<Widget> setupDisplay(FreezingDisplay display, Rectangle bounds) {
