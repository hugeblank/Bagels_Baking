...
public class BakingConfiguredFeatures {
    ...
    public static <FC extends FeatureConfig, F extends Feature<FC>> RegistryEntry<ConfiguredFeature<FC, ?>> register(String name, F feature, FC config) {
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, registryKey, new ConfiguredFeature<>(feature, config));
        return (RegistryEntry<ConfiguredFeature<FC, ?>>) registryKey;
    }
}
